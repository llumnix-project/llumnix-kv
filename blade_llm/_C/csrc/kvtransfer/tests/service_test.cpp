...
TEST(KVTransferServiceTest, TestReqMultiSourceReceive) {
  ...
  service.on_recv(Context::get_inst_id("1"), 0, "REQ_0001", {4, 5, 6});
  auto ret1 = service.check_recv_done("REQ_0001");
  EXPECT_TRUE(ret1.is_ok());
  EXPECT_TRUE(ret1.ok());
}
