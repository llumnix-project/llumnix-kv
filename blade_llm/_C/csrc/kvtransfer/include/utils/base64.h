#ifndef KVTRANSFER_INCLUDE_UTILS_BASE64_H_
#define KVTRANSFER_INCLUDE_UTILS_BASE64_H_
  ...
  while (it < input.end()) {
    for (std::size_t i = 0; i < 4; ++i) {
      ...
      if (*it >= 0x41 && *it <= 0x5A) temp |= *it - 0x41;
        ...
        switch (input.end() - it) {
          case 1:decoded.push_back((temp >> 16) & 0x000000FF);
            decoded.push_back((temp >> 8) & 0x000000FF);
            return decoded;
          case 2:decoded.push_back((temp >> 10) & 0x000000FF);
            return decoded;
...
#endif //KVTRANSFER_INCLUDE_UTILS_BASE64_H_
